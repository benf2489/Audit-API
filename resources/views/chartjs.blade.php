                            ...
                            <tr>
                                <td style="padding: 0;">
                                    ...
                                    <?php if( $full > 11 ) : ?>
                                        ...
                                        <p style="text-align: left; font-size: 16px; padding-top: 10px;">In our recent research, two of the three biggest threats to future success cited by respondents were access to new talent and the right technology. Your challenge now is to keep up with industry trends and ensure you’re anticipating new technologies, not reacting to them. As your clients’ businesses evolve, you need to evolve with them and ensure that you can always provide the timely and insightful information they need.</p>
                                    <?php elseif( $full < 5 ) : ?>
                                        <p style="text-align: left; font-size: 16px">You’re part of the 31% of accounting professionals who told us that their data is not yet consolidated in one central hub. Your financial information doesn’t update automatically, which means that your reports are often out of date as soon as they’re complete. While you are not alone, the bad news is that almost a half of respondents in our recent research told us they do have access to live data. While your competitors are making progress, you still have work to do.</p>
                        ...
                        <table cellpadding="0" cellpadding="0" style="width: 100%;">
                            <tr>
                                <td>
                                    ...
                                    <?php elseif( $wf < 5 ) : ?>
                                        <p style="text-align: left; font-size: 16px">You don’t have consistent workflows and processes across your firm, which means routine tasks take up too much time and may be prone to mistakes. Each team member has a different way of working, so your clients are likely to receive inconsistent levels of delivery. This should be an immediate concern for you, as almost three-quarters of respondents in our recent survey told us they already had a standardised way of working across their firm.</p>
         ...
         "responsive": false,
            ...
            "data":{
                ...
                "datasets":[
                    ...
                    {
                        'label': 'Average Score',  'data': [3.3,3.3,4.4],'backgroundColor': 'rgba(5,125,224, 0.3)','borderColor': 'rgba(5,125,224, 1)'
                    }
                ]
            },
            "options":{
         ...
         "responsive": false,
            ...
            "data":{
                ...
                "datasets":[
                    ...
                    {
                        'label': 'Average Score',  'data': [3.8,3.8,3.6],'backgroundColor': 'rgba(5,125,224, 0.3)','borderColor': 'rgba(5,125,224, 1)'
                    }
                ]
            },
            "options":{
         ...
         "responsive": false,
            ...
            "data":{
                ...
                "datasets":[{
                    ...
                    {
                        'label': 'Average Score',  'data': [3.5,2.9,3.1],'backgroundColor': 'rgba(5,125,224, 0.3)','borderColor': 'rgba(5,125,224, 1)'
                    }]
            },
            "options":{
                'legend': {
         ...
         "responsive": false,
            ...
            "data":{
                ...
                "datasets":[
                    ...
                    {
                        'label': 'Average Score',  'data': [2.7,3,3.5],'backgroundColor': 'rgba(5,125,224, 0.3)','borderColor': 'rgba(5,125,224, 1)'
                    }
                ]
            },
            "options":{
