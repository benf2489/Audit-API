                            ...
                            <tr>
                                <td style="padding: 0;">
                                    ...
                                    <?php if( $full > 11 ) : ?>
                                        ...
                                        <p style="text-align: left; font-size: 16px; padding-top: 10px;">In ons recente onderzoek zeggen de respondenten dat twee van de drie grootste bedreigingen voor hun toekomstig succes de toegang tot nieuw talent en de juiste technologie zijn. Jouw uitdaging is nu om op gelijke hoogte te blijven met trends in de sector en ervoor te zorgen dat je anticipeert en niet reageert op nieuwe technologieën. Naarmate de bedrijven van je klanten evolueren, moet je samen met hen evolueren en ervoor zorgen dat je altijd de tijdige en inzichtelijke informatie kan verstrekken die zij nodig hebben.</p>
                                    <?php elseif( $full < 5 ) : ?>
                                        <p style="text-align: left; font-size: 16px">Je maakt deel uit van de 31% van de accounting professionals die ons hebben verteld dat hun gegevens nog niet geconsolideerd zijn in één centrale hub. Jouw financiële informatie wordt niet automatisch bijgewerkt, wat betekent dat je rapporten vaak een verouderde versie van de realiteit zijn. Hoewel je niet alleen bent, is het minder goede nieuws voor jou dat ongeveer de helft van de respondenten in ons recente onderzoek ons vertelde dat ze wél toegang hebben tot live gegevens. Terwijl je concurrenten vooruitgang boeken, heb jij nog wat werk te doen.</p>
                                    ...
                                    <?php else : ?>
                                        <p style="text-align: left; font-size: 16px">Je hebt stappen ondernomen om je datastrategie te moderniseren en je hebt sommige cruciale informatie in realtime beschikbaar waardoor je jouw klanten in beperkte mate actuele analyses kan bieden. Maar je strategie blijft dus nog onvolledig, waardoor ook je dienstverlening inconsistent blijft en je niet altijd over de nodige informatie beschikt.</p>
                                        <p style="text-align: left; font-size: 16px; padding-top: 10px;">In ons recente onderzoek vertelde 37% van de accounting professionals dat hun grootste bedreiging voor toekomstig succes is dat ze “de veranderde de eisen van hun klanten niet kunnen bijbenen”. De accountants van vandaag moeten proactief advies geven op de momenten wanneer dat het meest nodig is. Enkel zo kunnen ze klanten tevreden houden. Daarom is het van vitaal belang om een samenhangende datastrategie te creëren waarbij alle belangrijke informatie onmiddellijk wordt bijgewerkt en steeds ter beschikking is, zonder enige manuele inspanning.</p>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellpadding="0" cellpadding="0" style="width: 100%;">
                            <tr>
                                <td>
                                    ...
                                    <?php else : ?>
                                        <p style="text-align: left; font-size: 16px">Het goede nieuws is dat je belangrijke stappen hebt gezet om je workflows te standaardiseren en automatiseren, wat je kantoor helpt groeien. Je dagelijkse taken verlopen degelijk en je team is in staat om goed samen te werken.</p>
                                        <p style="padding-top: 10px; text-align: left; font-size: 16px">Het is echter belangrijk dat je blijft verbeteren zodat je steeds het hoofd kan bieden aan uitdagingen die komen van je concurrenten of klanten. Uit ons recente onderzoek bij accounting professionals bleek dat 54% hun eigen workflows, rapporten en diensten kunnen ontwikkelen met behulp van hun technologieplatform. Door hun voorbeeld te volgen, kan je jouw diensten optimaliseren en te allen tijde de beste service garanderen.</p>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellpadding="0" cellpadding="0" style="width: 100%;">
                            <tr>
                                <td style="padding: 0;">
                                    ...
                                    <?php if( $rev > 11 ) : ?>
                                        <p style="text-align: left; font-size: 16px">Je data-analyse en reporting mogelijkheden zijn indrukwekkend. Je consolideert gegevens op een efficiënte manier zodat je belangrijke inzichten kan verkrijgen en je klanten vooruitstrevend advies kan geven. Doordat je deze stappen nam, behoor je tot de kleine minderheid van innovatieve accountants. Slechts 8% van onze respondenten is het sterk eens met de stelling dat ze inzicht kunnen krijgen in hun klantenbestand door het benchmarken van gegevens over hun gehele portfolio.</p>
                                    ...
                                    <?php elseif( $rev < 5 ) : ?>
                                        <p style="text-align: left; font-size: 16px">Op dit moment slaag je er nog niet in om nuttig om te springen met de data van je klanten en er het maximale uit te halen. De gegevens die je nu hebt, staan niet op één plek en er is geen eenvoudige manier om de onderliggende inzichten te achterhalen. Je hebt veel getallen, maar weinig waarde. Het goede nieuws is dat je niet de enige bent - slechts 6% van onze respondenten zegt dat ze in staat zijn om hun systemen te gebruiken om een gedetailleerde analyse van een account of hun hele klantenportefeuille te voltooien.</p>
                                    ...
                                    <?php else : ?>
                                        ...
                                        <p style="text-align: left; font-size: 16px; padding-top: 10px;">Nu ben je klaar om verder te bouwen aan adviesverlening van wereldklasse, gebaseerd op een sterke data-analyse. Diensten waarbij je verder kijkt dan de cijfers om je klant inzicht te laten verwerven en waarbij je de aard van je relatie met hen fundamenteel kan veranderen.</p>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        </table>
...
<div class="full-width" style="background-color: #ffffff; padding-top: 0; margin-top: 0;height:403px;">
    <table cellpadding="0" cellpadding="0" style="padding-left: 66px; padding-right: 66px; padding-top: 0; margin-top: 0px;">
        <tr>
            <td style="padding-top: 45px; padding-bottom: 40px; text-align: left;">
                            ...
                            <table class="chart-title" cellpadding="0" cellpadding="0" style="padding: 0; margin: 0;">
                                ...
                                <?php if( $total > 47 ) : ?>
                                    <td style="width: 48%; padding-right: 4%;">
                                        ...
                                        <p style="color: #708ea8; padding-bottom: 10px; font-size: 16px; line-height: 25px; font-weight: 400;">Het stelt je in staat je concurrentie voor te blijven en inkomsten te genereren uit de adviesdiensten die veel bedrijven zoeken.</p></td>
                                    <td style="width: 48%;">
                                        <p style="color: #708ea8; padding-bottom: 0px; font-size: 16px; line-height: 25px; padding-left: 10px; font-weight: 400;">Dus waarom zou je nu stilstaan en de rest jouw achterstand laten inhalen? Silverfin kan je helpen. Ons cloud-platform is de drijvende kracht achter connected accounting bij een aantal van 's werelds toonaangevende kantoren. En onze krachtige analyse- en reporting tools geven je de data en het inzicht dat je nodig hebt om de meest betrouwbare adviseur van je klanten te zijn.</p>
                                    </td>
                                <?php elseif( $total < 21 ) : ?>
                                    <td style="width: 48%; padding-right: 4%;">
                                        <p style="color: #012e44; padding-bottom: 16px; font-size: 18px; line-height: 26px; font-weight: 400;">Als een connected accountant heb je toegang tot de gegevens, tools en mensen die je nodig hebt om snel, efficiënt en accuraat te werken. Bovendien kan je ook eenvoudig je compliance werk transformeren.</p>
                                        <p style="color: #708ea8; padding-bottom: 8px; font-size: 16px; line-height: 25px; font-weight: 400;">Het betekent dat er geen financiële gegevens meer worden opgeslagen in silo’s of inconsistente processen binnen je kantoor. Jouw succes als connected account hangt af van de technologie die je gebruikt.</p></td>
                                    <td style="width: 48%;">
                                        <p style="color: #708ea8; padding-bottom: 0px; font-size: 16px; line-height: 25px; padding-left: 10px; font-weight: 400;">Het cloud platform van Silverfin maakt een connectie met alle boekhoud- en financiële systemen van je klanten en brengt de belangrijkste data automatisch binnen, ongeacht de bron. Met Silverfin werk je altijd vanuit een “single version of the truth” en kun je realtime data delen met klanten en collega’s. Zodra je data en processen gestandaardiseerd zijn, kan je ook jouw reporting en workflows automatiseren en aan je reis beginnen om een connected accountant te worden.</p>
                                    </td>
                                <?php else : ?>
                                    <td style="width: 48%; padding-right: 4%;">
                                        ...
                                        <p style="color: #708ea8; padding-bottom: 10px; font-size: 16px; line-height: 25px; font-weight: 400;">Je klanten vragen steeds vaker naar diensten met toegevoegde waarde, zoals advies. Hoewel je al een redelijke mate van digitale maturiteit vertoont, is het minder goede nieuws dat je concurrenten momenteel beter in staat zijn om aan de veranderende eisen van de klant te voldoen.</p></td>
                                    <td style="width: 48%;">
                                        <p style="color: #708ea8; padding-bottom: 0px; font-size: 16px; line-height: 25px; padding-left: 10px; font-weight: 400;">Het cloud platform van Silverfin maakt een connectie met de boekhoudkundige en financiële systemen van je klanten om alle gegevens te leveren die je nodig hebt - ongeacht de oorsprong. We automatiseren je compliance accounting workflows waardoor je snelheid, nauwkeurigheid en winstgevendheid toenemen. Vervolgens geven onze krachtige analyse- en reporting tools je de gegevens en het inzicht dat je nodig hebt om de meest betrouwbare adviseur van je klant te zijn.</p>
                                    </td>
                                <?php endif; ?>
                                </tr>
                            </table>
         ...
         "responsive": false,
            ...
            "data":{
                ...
                "datasets":[
                    ...
                    {
                        'label': 'Gemiddelde score',  'data': [3.3,3.3,4.4],'backgroundColor': 'rgba(5,125,224, 0.3)','borderColor': 'rgba(5,125,224, 1)'
                    }
                ]
            },
            "options":{
         ...
         "responsive": false,
            ...
            "data":{
                ...
                "datasets":[
                    ...
                    {
                        'label': 'Gemiddelde score',  'data': [3.8,3.8,3.6],'backgroundColor': 'rgba(5,125,224, 0.3)','borderColor': 'rgba(5,125,224, 1)'
                    }
                ]
            },
            "options":{
         ...
         "responsive": false,
            ...
            "data":{
                ...
                "datasets":[{
                    ...
                    {
                        'label': 'Gemiddelde score',  'data': [3.5,2.9,3.1],'backgroundColor': 'rgba(5,125,224, 0.3)','borderColor': 'rgba(5,125,224, 1)'
                    }]
            },
            "options":{
                'legend': {
         ...
         "responsive": false,
            ...
            "data":{
                ...
                "datasets":[
                    ...
                    {
                        'label': 'Gemiddelde score',  'data': [2.7,3,3.5],'backgroundColor': 'rgba(5,125,224, 0.3)','borderColor': 'rgba(5,125,224, 1)'
                    }
                ]
            },
            "options":{
