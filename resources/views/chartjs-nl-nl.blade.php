                            ...
                            <tr>
                                <td style="padding: 0;">
                                    ...
                                    <?php if( $full > 11 ) : ?>
                                        ...
                                        <p style="text-align: left; font-size: 14px; padding-top: 10px;">In ons recente onderzoek zeggen de respondenten dat twee van de drie grootste bedreigingen voor hun toekomstig succes te maken hebben met de toegang tot nieuw talent en de juiste technologie. Jouw uitdaging is nu om in de pas te blijven lopen met trends in de sector en ervoor te zorgen dat je anticipeert op nieuwe technologieën. Naarmate de bedrijven van je cliënten  zich verder ontwikkelen, moet jouw kantoor met hen mee evolueren, door ervoor te zorgen dat je altijd de tijdige en inzichtelijke informatie kunt verstrekken die zij nodig hebben.</p>
                                    <?php elseif( $full < 5 ) : ?>
                                        <p style="text-align: left; font-size: 14px">Je maakt deel uit van 31% van de accounting professionals die ons hebben verteld dat hun gegevens nog niet geconsolideerd zijn in één centrale hub. Jouw financiële informatie wordt niet automatisch bijgewerkt, wat betekent dat je rapporten vaak een verouderde versie van de realiteit zijn. Hoewel je niet alleen bent, is het minder goede nieuws voor jou dat ongeveer de helft van de respondenten in ons recente onderzoek ons vertelde dat ze wél toegang hebben tot realtime gegevens. Terwijl je concurrenten vooruitgang boeken, heb jij nog wat werk te doen.</p>
                        ...
                        <table cellpadding="0" cellpadding="0" style="width: 100%;">
                            <tr>
                                <td style="padding: 0;">
                                    ...
                                    <?php if( $rev > 11 ) : ?>
                                        <p style="text-align: left; font-size: 14px;">Je data-analyse- en reporting mogelijkheden zijn indrukwekkend. Je consolideert gegevens op een efficiënte manier, zodat je belangrijke inzichten verkrijgt waarmee je cliënten  vooruitstrevend kunt adviseren. Doordat je deze stappen nam, behoor je tot de kleine minderheid van innovatieve accountants. Slechts 8% van onze respondenten is het sterk eens met de stelling dat ze inzicht kunnen krijgen in hun klantenbestand door het benchmarken van gegevens over hun gehele portfolio.</p>
                                    ...
                                    <?php elseif( $rev < 5 ) : ?>
                                        <p style="text-align: left; font-size: 14px;">Op dit moment slaag je er nog niet in om nuttig om te springen met de data van je cliënten  en er het maximale uit te halen. De gegevens die je nu hebt, staan niet op één plek en er is geen eenvoudige manier om de onderliggende inzichten te achterhalen. Je hebt veel getallen, maar weinig waarde. Het goede nieuws is dat je niet de enige bent – slechts 6% van onze respondenten zegt dat ze in staat zijn om hun systemen te gebruiken om een gedetailleerde analyse van een cliënt , of van hun hele klantenportefeuille, te maken.</p>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php else : ?>
                                        ...
                                        <p style="padding-top: 10px; text-align: left; font-size: 16px">Bewapend met de juiste analyse en reporting tools én geconsolideerde klantgegevens, breng je jezelf in de beste positie om trends te zien wanneer ze zich voordoen. Én ben je in staat om te reageren met realtime advies, dat een positieve impact heeft op de activiteiten van je cliënten . Deze transformatie – van het leveren van hoofdzakelijk compliance diensten naar adviesdiensten – is slechts bereikt door 14% van de respondenten op onze enquête. Veranderingen die je vandaag doorvoert in je dienstverlening, skills en technologie-investeringen, zullen je in de beste positie brengen om je dienstenaanbod uit te breiden met adviesdiensten, voordat je concurrenten dit doen.</p>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        </table>
