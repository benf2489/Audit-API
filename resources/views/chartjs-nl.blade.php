    ...
    <table  cellpadding="0" cellpadding="0" style="padding-top: 0; padding-bottom: 20px;">
        <tr>
            ...
            <td align="right" style="padding-top: 0; margin-top: 0;">
                <p style="font-size: 18px; color: #012e44; width: 100%; text-align: right;"><strong>verbonden boekhouding</strong></p>
            </td>
        </tr>
    </table>
</div>
        ...
        <table cellpadding="0" cellpadding="0">
            <tr>
                <td style="padding-top: 120px; padding-bottom: 120px; text-align: center;">
                    <h1 style="color: #ffffff; font-size: 27px; line-height: 40px; padding-bottom: 15px;">Uw resultaten uitgelegd</h1>
